...
import com.l2j4team.events.manager.EventTask;
...
import com.l2j4team.gameserver.network.serverpackets.RadarControl;
...
public class CTF implements EventTask
{
	...
	{
		if (_player == null || !_player.isOnline() || !(_player.getX() > _eventCenterX - _eventOffset && _player.getX() < _eventCenterX + _eventOffset && _player.getY() > _eventCenterY - _eventOffset && _player.getY() < _eventCenterY + _eventOffset && _player.getZ() > _eventCenterZ - _eventOffset && _player.getZ() < _eventCenterZ + _eventOffset))
			return true;
		return false;
	}
