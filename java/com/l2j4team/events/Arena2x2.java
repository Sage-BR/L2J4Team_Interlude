		...
		public void rewards()
		{
			if (leader != null && leader.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					...
					if (!leader.is2x2Completed() && leader.getTournament2x2Cont() < Config.MISSION_2X2_CONT)
						leader.setTournament2x2Cont(leader.getTournament2x2Cont() + 1);
				}
			}
			...
			if (assist != null && assist.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					...
					if (!assist.is2x2Completed() && assist.getTournament2x2Cont() < Config.MISSION_2X2_CONT)
						assist.setTournament2x2Cont(assist.getTournament2x2Cont() + 1);
				}
			}
