	...
	private class Pair
	{
		...
		public void rewards()
		{
			...
			if (leader != null && leader.isOnline())
			{
				...
				{
					if (!leader.check_obj_mission(leader.getObjectId()))
						leader.updateMission();
					if (!leader.is9x9Completed() && leader.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						leader.setTournament9x9Cont(leader.getTournament9x9Cont() + 1);
				}
			}
			...
			if (assist != null && assist.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist.check_obj_mission(assist.getObjectId()))
						assist.updateMission();
					if (!assist.is9x9Completed() && assist.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist.setTournament9x9Cont(assist.getTournament9x9Cont() + 1);
				}
			}
			...
			if (assist2 != null && assist2.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist2.check_obj_mission(assist2.getObjectId()))
						assist2.updateMission();
					if (!assist2.is9x9Completed() && assist2.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist2.setTournament9x9Cont(assist2.getTournament9x9Cont() + 1);
				}
			}
			...
			if (assist3 != null && assist3.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist3.check_obj_mission(assist3.getObjectId()))
						assist3.updateMission();
					if (!assist3.is9x9Completed() && assist3.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist3.setTournament9x9Cont(assist3.getTournament9x9Cont() + 1);
				}
			}
			...
			if (assist4 != null && assist4.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist4.check_obj_mission(assist4.getObjectId()))
						assist4.updateMission();
					if (!assist4.is9x9Completed() && assist4.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist4.setTournament9x9Cont(assist4.getTournament9x9Cont() + 1);
				}
			...
			if (assist5 != null && assist5.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist5.check_obj_mission(assist5.getObjectId()))
						assist5.updateMission();
					if (!assist5.is9x9Completed() && assist5.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist5.setTournament9x9Cont(assist5.getTournament9x9Cont() + 1);
				}
			}
			...
			if (assist6 != null && assist6.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist6.check_obj_mission(assist6.getObjectId()))
						assist6.updateMission();
					if (!assist6.is9x9Completed() && assist6.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist6.setTournament9x9Cont(assist6.getTournament9x9Cont() + 1);
				}
			}
			...
			if (assist7 != null && assist7.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist7.check_obj_mission(assist7.getObjectId()))
						assist7.updateMission();
					if (!assist7.is9x9Completed() && assist7.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist7.setTournament9x9Cont(assist7.getTournament9x9Cont() + 1);
				}
			}
			...
			if (assist8 != null && assist8.isOnline())
			{
				...
				if (Config.ACTIVE_MISSION)
				{
					if (!assist8.check_obj_mission(assist8.getObjectId()))
						assist8.updateMission();
					if (!assist8.is9x9Completed() && assist8.getTournament9x9Cont() < Config.MISSION_9X9_CONT)
						assist8.setTournament9x9Cont(assist8.getTournament9x9Cont() + 1);
				}
			}
