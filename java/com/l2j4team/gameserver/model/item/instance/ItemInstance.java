package com.l2j4team.gameserver.model.item.instance;
...
import com.l2j4team.gameserver.model.DropProtection;
...
import com.l2j4team.gameserver.model.extender.BaseExtender;
import com.l2j4team.gameserver.model.item.MercenaryTicket;
...
import com.l2j4team.gameserver.network.serverpackets.DropItem;
import com.l2j4team.gameserver.network.serverpackets.GetItem;
...
public final class ItemInstance extends WorldObject implements Runnable, Comparable<ItemInstance>
{
	...
	private void updateItemAttributes(Connection pooledCon)
	{
		...
		Connection con = pooledCon == null ? L2DatabaseFactory.getInstance().getConnection() : pooledCon)
		{
