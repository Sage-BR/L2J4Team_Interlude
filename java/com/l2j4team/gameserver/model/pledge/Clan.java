package com.l2j4team.gameserver.model.pledge;
...
import com.l2j4team.gameserver.model.itemcontainer.ClanWarehouse;
...
import com.l2j4team.gameserver.network.serverpackets.PledgeReceiveSubPledgeCreated;
import com.l2j4team.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import com.l2j4team.gameserver.network.serverpackets.PledgeShowMemberListAll;
import com.l2j4team.gameserver.network.serverpackets.PledgeShowMemberListDeleteAll;
...
import com.l2j4team.gameserver.network.serverpackets.PledgeSkillListAdd;
...
public class Clan
{
	...
	{
		if (!_leader.isOnline() || member == null || !member.isOnline())
			return;
	...
	{
		setclanBossScore(_clanBossScore + value);
	}
	...
	{
		setclan5x5Score(_clan5x5Score + value);
	}
