...
import com.l2j4team.gameserver.model.zone.type.L2OlympiadStadiumZone;
import com.l2j4team.gameserver.network.SystemMessageId;
import com.l2j4team.gameserver.network.serverpackets.ExOlympiadUserInfo;
	...
	protected final boolean haveWinner()
	{
		...
		try
		{
			if (_playerOne.player.getOlympiadGameId() == _stadiumID)
				playerOneLost = (_playerOne.player.isDead() || !_playerOne.player.isInsideZone(ZoneId.OLYMPIAD));
		}
		catch (Exception e)
		{
			playerOneLost = true;
		...
		try
		{
			if (_playerTwo.player.getOlympiadGameId() == _stadiumID)
				playerTwoLost = (_playerTwo.player.isDead() || !_playerTwo.player.isInsideZone(ZoneId.OLYMPIAD));
		}
		catch (Exception e)
		{
			playerTwoLost = true;
