...
import com.l2j4team.gameserver.BalanceLoad;
...
public class CreatureStat
{
	...
	public int getEvasionRate(Creature target)
	{
		...
		{
			val += BalanceLoad.Evasion[((Player) _activeChar).getClassId().getId() - 88];
		}
		if (val >= 0)
			return (int) val;
		return 0;
	...
	public int getAccuracy()
	{
		...
		if (_activeChar instanceof Player && ((Player) _activeChar).getClassId().getId() >= 88)
		{
			val += BalanceLoad.Accuracy[((Player) _activeChar).getClassId().getId() - 88];
		}
		if (val > 0)
			return (int) val;
		return 0;
	...
	public int getMaxHp()
	{
		...
		if (_activeChar instanceof Player && ((Player) _activeChar).getClassId().getId() >= 88)
		{
			val += BalanceLoad.HP[((Player) _activeChar).getClassId().getId() - 88];
		}
		if (val > 0)
			return (int) val;
		return 0;
	...
	public int getMaxMp()
	{
		...
		if (_activeChar instanceof Player && ((Player) _activeChar).getClassId().getId() >= 88)
		{
			val += BalanceLoad.MP[((Player) _activeChar).getClassId().getId() - 88];
		}
		if (val >= 0)
			return (int) val;
		return 0;
	...
	public int getMAtkSpd()
	{
		...
		if (_activeChar instanceof Player && ((Player) _activeChar).getClassId().getId() >= 88)
		{
			val += BalanceLoad.MAtkSpd[((Player) _activeChar).getClassId().getId() - 88];
		}
		if (val >= 0)
			return (int) val;
		return 0;
