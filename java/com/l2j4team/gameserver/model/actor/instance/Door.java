...
import com.l2j4team.gameserver.model.actor.ai.type.DoorAI;
import com.l2j4team.gameserver.model.actor.stat.DoorStat;
import com.l2j4team.gameserver.model.actor.status.DoorStatus;
import com.l2j4team.gameserver.model.actor.template.DoorTemplate;
import com.l2j4team.gameserver.model.actor.template.DoorTemplate.DoorType;
import com.l2j4team.gameserver.model.actor.template.DoorTemplate.OpenType;
...
import com.l2j4team.gameserver.network.serverpackets.DoorInfo;
import com.l2j4team.gameserver.network.serverpackets.DoorStatusUpdate;
...
public class Door extends Creature implements IGeoObject
{
	...
	{
		if ((getTemplate().getType() == DoorType.WALL && !(attacker instanceof SiegeSummon)) || !(_castle != null && _castle.getSiege().isInProgress()))
			return;
