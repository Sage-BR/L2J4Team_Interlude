...
public class Hero
{
	...
	private static final String DELETE_ITEMS = "DELETE FROM items WHERE item_id IN (6611, 6612, 6613, 6614, 6615, 6616, 6617, 6618, 6619, 6620, 6621) AND owner_id NOT IN (SELECT obj_Id FROM characters WHERE accesslevel > 0)";
