package com.l2j4team.gameserver.model.zone.form;

import com.l2j4team.gameserver.model.zone.L2ZoneForm;
...
public class ZoneCuboid extends L2ZoneForm
{
	...
	public boolean intersectsRectangle(int ax1, int ax2, int ay1, int ay2)
	{
		...
		if (lineSegmentsIntersect(_x1, _y1, _x2, _y1, ax1, ay1, ax1, ay2) || lineSegmentsIntersect(_x1, _y1, _x2, _y1, ax2, ay1, ax2, ay2) || lineSegmentsIntersect(_x1, _y2, _x2, _y2, ax1, ay1, ax1, ay2) || lineSegmentsIntersect(_x1, _y2, _x2, _y2, ax2, ay1, ax2, ay2))
			return true;
