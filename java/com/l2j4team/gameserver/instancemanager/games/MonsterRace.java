package com.l2j4team.gameserver.instancemanager.games;
...
import com.l2j4team.gameserver.model.zone.type.L2DerbyTrackZone;
import com.l2j4team.gameserver.network.SystemMessageId;
import com.l2j4team.gameserver.network.serverpackets.DeleteObject;
import com.l2j4team.gameserver.network.serverpackets.MonRaceInfo;
	...
	public void newRace()
	{
		...
		for (int i = 0; i < 8; i++)
		{
			try
			{
				...
				_constructor = Class.forName("com.l2j4team.gameserver.model.actor.instance." + template.getType()).getConstructors()[0];
