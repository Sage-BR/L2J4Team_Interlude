package com.l2j4team.gameserver.scripting.quests;
...
import com.l2j4team.gameserver.model.soulcrystal.LevelingInfo;
import com.l2j4team.gameserver.model.soulcrystal.SoulCrystal;
...
public class Q350_EnhanceYourWeapon extends Quest
{
	...
	public String onItemUse(ItemInstance item, Player user, WorldObject target)
	{
		...
		if (user.isDead() || target == null || !(target instanceof Attackable))
			return null;
