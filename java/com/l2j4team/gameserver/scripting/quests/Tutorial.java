			...
			switch (eventId)
			{
				...
				case 40:
					if ((playerLevel == 5) && (player.getClassId().level() == 0))
					{
						if (st.getInt("lvl") < 5)
						{
							if (!(player.getClassId().getType() == ClassType.MYSTIC) || (classId == 49))
							{
					...
					else if ((playerLevel == 7) && player.getClassId().getType() == ClassType.MYSTIC && (classId != 49))
					{
