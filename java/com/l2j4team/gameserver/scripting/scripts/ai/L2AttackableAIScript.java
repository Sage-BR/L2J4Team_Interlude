package com.l2j4team.gameserver.scripting.scripts.ai;
...
public class L2AttackableAIScript extends Quest
{
	...
	protected void registerNpcs()
	{
		...
		for (NpcTemplate template : NpcTable.getInstance().getAllNpcs())
		{
			try
			{
				if (Attackable.class.isAssignableFrom(Class.forName("com.l2j4team.gameserver.model.actor.instance." + template.getType())))
				{
