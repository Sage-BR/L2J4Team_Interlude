package com.l2j4team.gameserver.scripting.scripts.ai.individual;
...
import com.l2j4team.gameserver.network.serverpackets.SpecialCamera;
 ...
 * @author JOJO Update by rocknow Updated by L2jOff team Updated by Eduardo da Silva Souza (@edusz93)
 */
...
public class Frintezza extends L2AttackableAIScript
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			_Zone.broadcastPacket(new CreatureSay(0, 1, "Hall Alarm Device", "Intruders! Sound the alarm!"));
			for (int i = 0; i <= 17; i++)
			{
	...
	public String onKill(Npc npc, Player killer, boolean isPet)
	{
		...
		else if (npc.getNpcId() == 18328)
		{
			...
			{
				_Zone.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "De-activate the alarm."));
