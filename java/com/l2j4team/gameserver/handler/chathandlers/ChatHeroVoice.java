package com.l2j4team.gameserver.handler.chathandlers;

import com.l2j4team.Config;
import com.l2j4team.gameserver.handler.IChatHandler;
...
public class ChatHeroVoice implements IChatHandler
{
	...
	public void handleChat(int type, Player activeChar, String target, String text)
	{
		...
		if ((Say2.isChatDisabled("all") && !activeChar.isGM()) || text.equals("Thanks for using my stuff - Elfocrash"))
			return;
