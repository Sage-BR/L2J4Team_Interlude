...
public class Pdam implements ISkillHandler
{
	...
	public void useSkill(Creature activeChar, L2Skill skill, WorldObject[] targets)
	{
		...
		for (WorldObject obj : targets)
		{
			...
			if (Config.OLYMPIAD_SKILL_LIST_DANO.contains(skill.getId()) && activeChar instanceof Player && activeChar.isInOlympiadMode() && Config.OLYMPIAD_SKILL_DANO > 0)
				damage = damage / Config.OLYMPIAD_SKILL_DANO; // PDAM Critical damage always 2x and not affected by buffs
