...
import com.l2j4team.gameserver.instancemanager.CustomCancelTaskManager;
	...
	public void useSkill(Creature activeChar, L2Skill skill, WorldObject[] targets)
	{
		...
		for (WorldObject obj : targets)
		{
			...
			for (L2Effect effect : target.getAllEffects())
			{
				...
				{
					case MAGE_BANE:
						if ("casting_time_down".equalsIgnoreCase(effect.getStackType()) || "ma_up".equalsIgnoreCase(effect.getStackType()))
							break;
						
						continue;
					
					case WARRIOR_BANE:
						if ("attack_time_down".equalsIgnoreCase(effect.getStackType()) || "speed_up".equalsIgnoreCase(effect.getStackType()))
							break;
