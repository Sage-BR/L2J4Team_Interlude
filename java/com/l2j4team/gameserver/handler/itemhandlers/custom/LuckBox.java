...
public class LuckBox implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{
			case 0:
				if (Rnd.get(100) < Config.CHANCE_ITEM_1)
				{
			...
			case 1:
				if (Rnd.get(100) < Config.CHANCE_ITEM_2)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 2:
				if (Rnd.get(100) < Config.CHANCE_ITEM_3)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 3:
				if (Rnd.get(100) < Config.CHANCE_ITEM_4)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 4:
				if (Rnd.get(100) < Config.CHANCE_ITEM_5)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 5:
				if (Rnd.get(100) < Config.CHANCE_ITEM_6)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 6:
				if (Rnd.get(100) < Config.CHANCE_ITEM_7)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 7:
				if (Rnd.get(100) < Config.CHANCE_ITEM_8)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 8:
				if (Rnd.get(100) < Config.CHANCE_ITEM_9)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 9:
				if (Rnd.get(100) < Config.CHANCE_ITEM_10)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			...
			case 10:
				if (Rnd.get(100) < Config.CHANCE_ITEM_11)
				{
					playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
