...
import com.l2j4team.gameserver.network.serverpackets.GMViewCharacterInfo;
import com.l2j4team.gameserver.network.serverpackets.GMViewHennaInfo;
import com.l2j4team.gameserver.network.serverpackets.GMViewItemList;
import com.l2j4team.gameserver.network.serverpackets.GMViewPledgeInfo;
import com.l2j4team.gameserver.network.serverpackets.GMViewQuestList;
import com.l2j4team.gameserver.network.serverpackets.GMViewSkillInfo;
import com.l2j4team.gameserver.network.serverpackets.GMViewWarehouseWithdrawList;
...
public final class RequestGMCommand extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((activeChar == null) || !activeChar.isGM() || !activeChar.getAccessLevel().allowAltG())
			return;
