...
import com.l2j4team.gameserver.network.serverpackets.PledgeReceiveMemberInfo;
...
public final class RequestPledgeReorganizeMember extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((clan == null) || ((activeChar.getClanPrivileges() & Clan.CP_CL_MANAGE_RANKS) != Clan.CP_CL_MANAGE_RANKS))
			return;
