...
import com.l2j4team.gameserver.model.L2PledgeSkillLearn;
...
import com.l2j4team.gameserver.model.actor.instance.VillageMaster;
...
import com.l2j4team.gameserver.network.serverpackets.ShortCutRegister;
	...
	protected void runImpl()
	{
		...
		switch (_skillType)
		{
			case 0: // General skills.
				...
				if ((skillLvl >= _skillLevel) || (Math.max(skillLvl, 0) + 1 != _skillLevel))
					return;
