...
public final class RequestPrivateStoreBuy extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((storePlayer == null) || player.isCursedWeaponEquipped() || !player.isInsideRadius(storePlayer, 150, true, false) || !(storePlayer.getStoreType() == StoreType.SELL || storePlayer.getStoreType() == StoreType.PACKAGE_SELL))
			return;
