...
public final class DlgAnswer extends L2GameClientPacket
{
	...
	public void runImpl()
	{
		...
		{
			if (AdminRecallAll.isAdminSummoning && _answer == 1)
			{
		...
		{
			if (Announcement.tvt_register && _answer == 1)
