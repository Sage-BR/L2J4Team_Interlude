...
public final class RequestHennaEquip extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (!activeChar.reduceAdena("Henna", henna.getPrice(), activeChar.getCurrentFolkNPC(), true) || !activeChar.destroyItemByItemId("Henna", henna.getDyeId(), Henna.getRequiredDyeAmount(), activeChar, true))
			return;
