...
import com.l2j4team.gameserver.network.serverpackets.AskJoinParty;
...
public final class RequestJoinParty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.ANTZERG_CHECK_PARTY_INVITE && target.getClan() != requestor.getClan())
		{
			...
			if (target.isInsideZone(ZoneId.RAID) || requestor.isInsideZone(ZoneId.RAID) || target.isInsideZone(ZoneId.RAID_NO_FLAG) || requestor.isInsideZone(ZoneId.RAID_NO_FLAG))
			{
