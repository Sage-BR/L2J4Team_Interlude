 ...
 */
package com.l2j4team.commons.util;
 ...
 * In case there is no text appended before the cycle, just use <code>new StringBuilder(1300)</code>.
 ...
 * time, so this cannot be used for cases like <code>final String objectIdString = String.valueOf(getObjectId)</code>.
